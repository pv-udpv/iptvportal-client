        ...
        result = client.execute(
            {
                ...
                "id": 1,
                "method": "select",
                "params": {"data": ["id", "username"], "from": "subscriber", "limit": 5},
            }
        )
...
def api_comparison():
    ...
    with client:
        ...
        result = client.execute({"jsonrpc": "2.0", "id": 1, "method": "select", "params": jsonsql})
        ...
        query_input = SQLQueryInput(sql="SELECT * FROM subscriber LIMIT 5", use_schema_mapping=True)
        result = service.execute_sql(query_input)
